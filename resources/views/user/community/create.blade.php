...
<div class="p-4 mx-auto">
  <div class="row m-4">
   <form action="{{ action('User\CommunityController@create') }}" method="post" class="col-md-12" enctype="multipart/form-data" >
     @csrf
     @if (count($errors) > 0)
     <ul>
     ...
     <div class="float-right pb-6">
        ...
        <button type="submit" class="m-2 btn btn-primary">コミュニティを作成する</button>
     </div>
   </form>
  </div>
</div>
